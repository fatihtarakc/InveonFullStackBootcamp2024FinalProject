...
{
    public class IdentityUserConfirmEmailValidator : AbstractBaseValidator<IdentityUserConfirmEmailDto>
    {
        public IdentityUserConfirmEmailValidator(IStringLocalizer<MessageResources> stringLocalizer) : base(stringLocalizer)
        {
            ...
            RuleFor(identityUser => identityUser.VerificationType)
                ...
                .Equal(VerificationType.ConfirmEmail).WithMessage(stringLocalizer[Message.Account_Please_Select_Correct_VerificationType]);
        }
    }
}