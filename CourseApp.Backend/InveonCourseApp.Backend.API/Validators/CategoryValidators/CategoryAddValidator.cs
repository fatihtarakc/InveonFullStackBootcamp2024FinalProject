...
{
    public class CategoryAddValidator : AbstractBaseValidator<CategoryAddDto>
    {
        public CategoryAddValidator(IStringLocalizer<MessageResources> stringLocalizer) : base(stringLocalizer)
        {
