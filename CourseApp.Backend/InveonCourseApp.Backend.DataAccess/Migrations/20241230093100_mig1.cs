        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("Course_ImageUrl_MinLength_Control", "Len(ImageUrl) >= 5");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("Order_TotalCourseAmount_Min_Control", "TotalCourseAmount > 0");
                    table.CheckConstraint("Order_TotalCoursePrice_Min_Control", "TotalCoursePrice >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("Payment_Price_Min_Control", "Price >= 0");
                });
