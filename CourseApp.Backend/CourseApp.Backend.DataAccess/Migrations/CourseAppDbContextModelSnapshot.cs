// <auto-generated />
using System;
using CourseApp.Backend.DataAccess.Context;
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseApp.Backend.Entities.Concrete.Admin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CourseApp.Backend.Entities.Concrete.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourseApp.Backend.Entities.Concrete.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourseApp.Backend.Entities.Concrete.CourseOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourseApp.Backend.Entities.Concrete.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourseApp.Backend.Entities.Concrete.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Payments", t =>
                        {
                            ...
                            t.HasCheckConstraint("Payment_TotalCourseAmount_Min_Control", "TotalCourseAmount > 0");

                            t.HasCheckConstraint("Payment_TotalCoursePrice_Min_Control", "TotalCoursePrice >= 0");
                        });
                });

            modelBuilder.Entity("CourseApp.Backend.Entities.Concrete.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourseApp.Backend.Entities.Concrete.StudentCourse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourseApp.Backend.Entities.Concrete.Trainer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourseApp.Backend.Entities.Concrete.CourseOrder", b =>
                {
                    b.HasOne("CourseApp.Backend.Entities.Concrete.Course", "Course")
                        .WithMany("CourseOrders")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CourseApp.Backend.Entities.Concrete.Order", "Order")
                        .WithMany("CourseOrders")
            ...
            modelBuilder.Entity("CourseApp.Backend.Entities.Concrete.StudentCourse", b =>
                {
                    ...
                    b.HasOne("CourseApp.Backend.Entities.Concrete.Student", "Student")
                        .WithMany("StudentCourses")
